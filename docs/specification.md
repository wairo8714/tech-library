...
社内参考書の管理拠点、重複購入、検索、貸出状況を管理できるCLIアプリを作る。
...
2. アプリは書籍ID、タイトル、作者、ジャンル、管理拠点を対象に検索する
...
- `managed_location` は現在地ではなく、その本を管理している施設・部署を表す
...
| 管理拠点 | 本を管理する施設・部署。現在地ではなく管理区分を表す |
...
- 本を新規登録する
- 書籍IDを自動採番する
- タイトル、著者、ジャンル、管理拠点を対話形式で受け取る
- 作者・ジャンルはカンマ区切りで受け取り、配列として保存する
- 管理拠点は、その本を管理する施設・部署として保存する
...
- 書籍ID、タイトル、作者、ジャンル、管理拠点を対象に検索する
